...
#define AI_NETWORK_MODEL_SIGNATURE     "0xc5f34db57fb4ee0aa68685d5d7eecedc"
...
#define AI_TOOLS_DATE_TIME   "2026-07-15T16:51:29+0530"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 232, 1, 1),
    232, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    linear_output_array.data = AI_PTR(g_network_activations_map[0] + 16);
    linear_output_array.data_start = AI_PTR(g_network_activations_map[0] + 16);
    relu_output_array.data = AI_PTR(g_network_activations_map[0] + 16);
    relu_output_array.data_start = AI_PTR(g_network_activations_map[0] + 16);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    linear_bias_array.data = AI_PTR(g_network_weights_map[0] + 128);
    linear_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 128);
    output_weights_array.format |= AI_FMT_FLAG_CONST;
    output_weights_array.data = AI_PTR(g_network_weights_map[0] + 160);
    output_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 160);
    output_bias_array.format |= AI_FMT_FLAG_CONST;
    output_bias_array.data = AI_PTR(g_network_weights_map[0] + 224);
    output_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 224);
    return true;
  }
